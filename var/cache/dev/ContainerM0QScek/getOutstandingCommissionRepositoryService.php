 ...
 */
class getOutstandingCommissionRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\OutstandingCommissionRepository' shared autowired service.
     *
     * @return \App\Repository\OutstandingCommissionRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'OutstandingCommissionRepository.php';

        return $container->privates['App\\Repository\\OutstandingCommissionRepository'] = new \App\Repository\OutstandingCommissionRepository(($container->privates['App\\Repository\\PoliceRepository'] ?? $container->load('getPoliceRepositoryService')), ($container->privates['App\\Repository\\PaiementCommissionRepository'] ?? $container->load('getPaiementCommissionRepositoryService')));
    }
}
