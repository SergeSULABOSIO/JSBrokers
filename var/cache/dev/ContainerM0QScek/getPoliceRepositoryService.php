 ...
 */
class getPoliceRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PoliceRepository' shared autowired service.
     *
     * @return \App\Repository\PoliceRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PoliceRepository.php';

        return $container->privates['App\\Repository\\PoliceRepository'] = new \App\Repository\PoliceRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
