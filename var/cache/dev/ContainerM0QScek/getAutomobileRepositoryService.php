 ...
 */
class getAutomobileRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\AutomobileRepository' shared autowired service.
     *
     * @return \App\Repository\AutomobileRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'AutomobileRepository.php';

        return $container->privates['App\\Repository\\AutomobileRepository'] = new \App\Repository\AutomobileRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
