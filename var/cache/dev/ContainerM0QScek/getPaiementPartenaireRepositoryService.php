 ...
 */
class getPaiementPartenaireRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PaiementPartenaireRepository' shared autowired service.
     *
     * @return \App\Repository\PaiementPartenaireRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PaiementPartenaireRepository.php';

        return $container->privates['App\\Repository\\PaiementPartenaireRepository'] = new \App\Repository\PaiementPartenaireRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
