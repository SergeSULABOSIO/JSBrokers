 ...
 */
class getTaxeRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\TaxeRepository' shared autowired service.
     *
     * @return \App\Repository\TaxeRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TaxeRepository.php';

        return $container->privates['App\\Repository\\TaxeRepository'] = new \App\Repository\TaxeRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
