...
class getForm_RegistryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['form.registry'] = new \Symfony\Component\Form\FormRegistry([0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService, [
            'App\\Form\\AssureurFormType' => ['privates', 'App\\Form\\AssureurFormType', 'getAssureurFormTypeService', true],
            'App\\Form\\AutomobileFormType' => ['privates', 'App\\Form\\AutomobileFormType', 'getAutomobileFormTypeService', true],
            'App\\Form\\ClientFormType' => ['privates', 'App\\Form\\ClientFormType', 'getClientFormTypeService', true],
            'App\\Form\\ContactFormType' => ['privates', 'App\\Form\\ContactFormType', 'getContactFormTypeService', true],
            'App\\Form\\EntrepriseFormType' => ['privates', 'App\\Form\\EntrepriseFormType', 'getEntrepriseFormTypeService', true],
            'App\\Form\\MonnaieFormType' => ['privates', 'App\\Form\\MonnaieFormType', 'getMonnaieFormTypeService', true],
            'App\\Form\\PaiementCommissionFormType' => ['privates', 'App\\Form\\PaiementCommissionFormType', 'getPaiementCommissionFormTypeService', true],
            'App\\Form\\PaiementPartenaireFormType' => ['privates', 'App\\Form\\PaiementPartenaireFormType', 'getPaiementPartenaireFormTypeService', true],
            'App\\Form\\PaiementTaxeFormType' => ['privates', 'App\\Form\\PaiementTaxeFormType', 'getPaiementTaxeFormTypeService', true],
            'App\\Form\\PartenaireFormType' => ['privates', 'App\\Form\\PartenaireFormType', 'getPartenaireFormTypeService', true],
            'App\\Form\\PoliceFormType' => ['privates', 'App\\Form\\PoliceFormType', 'getPoliceFormTypeService', true],
            'App\\Form\\ProduitFromType' => ['privates', 'App\\Form\\ProduitFromType', 'getProduitFromTypeService', true],
            'App\\Form\\TaxeFormType' => ['privates', 'App\\Form\\TaxeFormType', 'getTaxeFormTypeService', true],
            ...
            'App\\Form\\AssureurFormType' => '?',
            'App\\Form\\AutomobileFormType' => '?',
            'App\\Form\\ClientFormType' => '?',
            'App\\Form\\ContactFormType' => '?',
            'App\\Form\\EntrepriseFormType' => '?',
            'App\\Form\\MonnaieFormType' => '?',
            'App\\Form\\PaiementCommissionFormType' => '?',
            'App\\Form\\PaiementPartenaireFormType' => '?',
            'App\\Form\\PaiementTaxeFormType' => '?',
            'App\\Form\\PartenaireFormType' => '?',
            'App\\Form\\PoliceFormType' => '?',
            'App\\Form\\ProduitFromType' => '?',
            'App\\Form\\TaxeFormType' => '?',
