 ...
 */
class getPaiementCommissionRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PaiementCommissionRepository' shared autowired service.
     *
     * @return \App\Repository\PaiementCommissionRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PaiementCommissionRepository.php';

        return $container->privates['App\\Repository\\PaiementCommissionRepository'] = new \App\Repository\PaiementCommissionRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
