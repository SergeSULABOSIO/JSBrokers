 ...
 */
class getMonnaieRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\MonnaieRepository' shared autowired service.
     *
     * @return \App\Repository\MonnaieRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'MonnaieRepository.php';

        return $container->privates['App\\Repository\\MonnaieRepository'] = new \App\Repository\MonnaieRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
